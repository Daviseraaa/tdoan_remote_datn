...
import { workflowAgentLabel } from '@/src/lib/workflowAgent';
...
export function WorkflowCard({
  ...
  const agentLabel = workflowAgentLabel(workflow, agents);
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-[10px] font-mono text-on-surface-variant mt-1 uppercase tracking-wide">
            ...
            <span className="normal-case tracking-normal">
              {t('workflows.cardAgent')}:{' '}
              <span className="text-on-surface font-bold">{agentLabel}</span>
            </span>
          </p>
        </div>
        <span
