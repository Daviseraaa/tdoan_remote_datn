...
-- CreateEnum
CREATE TYPE "TaskType" AS ENUM ('COMMAND', 'SCRIPT', 'FILE_OPERATION', 'SYSTEM_INFO', 'OPEN_APP', 'OPEN_BROWSER', 'DESKTOP_AUTOMATION', 'CHROME_EXTENSION', 'SCREEN_CAPTURE', 'HTTP_REQUEST');
...
-- CreateEnum
CREATE TYPE "StepType" AS ENUM ('COMMAND', 'SCRIPT', 'DELAY', 'CONDITION', 'TELEGRAM');
